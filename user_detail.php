    ...
    <legend>ユーザー更新</legend>
     ...
     <label>管理FLG：
          <?php if($row["kanri_flg"]=="0"){ ?>
              サプライヤー<input type="radio" name="kanri_flg" value="0" checked="checked">　
              管理者<input type="radio" name="kanri_flg" value="1">
              ユーザー<input type="radio" name="kanri_flg" value="2">
          <?php }elseif($row["kanri_flg"]=="1"){ ?>
          ...
          <?php }else{ ?>
              一般<input type="radio" name="kanri_flg" value="0">　
              管理者<input type="radio" name="kanri_flg" value="1">
              ユーザー<input type="radio" name="kanri_flg" value="2" checked="checked">
